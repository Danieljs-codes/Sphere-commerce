...
const DialogBody = ({ className, ref, ...props }: DialogBodyProps) => (
	<div
		...
		ref={ref}
		className={twMerge(
			"flex max-h-[calc(var(--visual-viewport-height,100vh)-var(--visual-viewport-vertical-padding,0px)-var(--dialog-header-height,0px)-var(--dialog-footer-height,0px))] flex-1 flex-col overflow-auto px-(--gutter) py-1",
			className,
		)}
		{...props}
	/>
...
const DialogFooter = ({ className, ...props }: DialogFooterProps) => {
	...
	return (
		<div
			...
			className={twMerge(
				"mt-auto flex shrink-0 flex-col-reverse justify-between gap-3 p-(--gutter) pt-[calc(var(--gutter)---spacing(3))] group-not-has-data-[slot=dialog-body]/dialog:pt-0 group-not-has-data-[slot=dialog-body]/popover:pt-0 sm:flex-row",
				className,
			)}
			{...props}
		/>
